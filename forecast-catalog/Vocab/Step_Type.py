    ...
    '*': [
        {
            ...
            'source': [{
                'outbound': ['Vocab', 'Step_Type_RCB_fkey']
            }, 'ID']
        }, {
            'source': [{
                'outbound': ['Vocab', 'Step_Type_RMB_fkey']
            }, 'ID']
        }, {
            'source': [{
                'outbound': ['Vocab', 'Step_Type_Catalog_Group_fkey']
            }, 'ID']
        }
    ]
}
...
key_defs = [
    em.Key.define(['uri'], constraint_names=[['Vocab', 'Step_Type_urikey1']],
                  ),
    em.Key.define(['id'], constraint_names=[['Vocab', 'Step_Type_idkey1']],
                  ),
    em.Key.define(['RID'], constraint_names=[['Vocab', 'Step_Type_RIDkey1']],
                  ),
]
...
fkey_defs = [
    em.ForeignKey.define(
        ...
        'public',
        'Catalog_Group', ['ID'],
        constraint_names=[['Vocab', 'Step_Type_Catalog_Group_fkey']],
        acls={
    ...
    em.ForeignKey.define(
        ...
        'public',
        'ERMrest_Client', ['ID'],
        constraint_names=[['Vocab', 'Step_Type_RCB_fkey']],
        acls={
            'insert': ['*'],
            'update': ['*']
        },
    ...
    em.ForeignKey.define(
        ...
        'public',
        'ERMrest_Client', ['ID'],
        constraint_names=[['Vocab', 'Step_Type_RMB_fkey']],
        acls={
            'insert': ['*'],
            'update': ['*']
        },
