    ...
    '*': [
        {
            ...
            'source': [{
                'outbound': ['Vocab', 'Science_RCB_fkey']
            }, 'ID']
        }, {
            'source': [{
                'outbound': ['Vocab', 'Science_RMB_fkey']
            }, 'ID']
        }, {
            'source': [{
                'outbound': ['Vocab', 'Science_Catalog_Group_fkey']
            }, 'ID']
        }
    ]
}
...
key_defs = [
    em.Key.define(['URI'], constraint_names=[['Vocab', 'Science_URIkey1']],
                  ),
    em.Key.define(['RID'], constraint_names=[['Vocab', 'Science_RIDkey1']],
                  ),
    em.Key.define(['ID'], constraint_names=[['Vocab', 'Science_IDkey1']],
                  ),
]
...
fkey_defs = [
    em.ForeignKey.define(
        ...
        'public',
        'Catalog_Group', ['ID'],
        constraint_names=[['Vocab', 'Science_Catalog_Group_fkey']],
        acls={
    ...
    em.ForeignKey.define(
        ...
        'public',
        'ERMrest_Client', ['ID'],
        constraint_names=[['Vocab', 'Science_RCB_fkey']],
        acls={
            'insert': ['*'],
            'update': ['*']
        },
    ...
    em.ForeignKey.define(
        ...
        'public',
        'ERMrest_Client', ['ID'],
        constraint_names=[['Vocab', 'Science_RMB_fkey']],
        acls={
            'insert': ['*'],
            'update': ['*']
        },
