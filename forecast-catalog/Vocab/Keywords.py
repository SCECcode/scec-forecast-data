    ...
    '*': [
        {
            ...
            'source': [{
                'outbound': ['Vocab', 'Keywords_RCB_fkey']
            }, 'ID']
        }, {
            'source': [{
                'outbound': ['Vocab', 'Keywords_RMB_fkey']
            }, 'ID']
        }, {
            'source': [{
                'outbound': ['Vocab', 'Keywords_Catalog_Group_fkey']
            }, 'ID']
        }
    ]
}
...
key_defs = [
    em.Key.define(['id'], constraint_names=[['Vocab', 'Keywords_idkey1']],
                  ),
    em.Key.define(['uri'], constraint_names=[['Vocab', 'Keywords_urikey1']],
                  ),
    em.Key.define(['RID'], constraint_names=[['Vocab', 'Keywords_RIDkey1']],
                  ),
]
...
fkey_defs = [
    em.ForeignKey.define(
        ...
        'public',
        'Catalog_Group', ['ID'],
        constraint_names=[['Vocab', 'Keywords_Catalog_Group_fkey']],
        acls={
    ...
    em.ForeignKey.define(
        ...
        'public',
        'ERMrest_Client', ['ID'],
        constraint_names=[['Vocab', 'Keywords_RCB_fkey']],
        acls={
            'insert': ['*'],
            'update': ['*']
        },
    ...
    em.ForeignKey.define(
        ...
        'public',
        'ERMrest_Client', ['ID'],
        constraint_names=[['Vocab', 'Keywords_RMB_fkey']],
        acls={
            'insert': ['*'],
            'update': ['*']
        },
